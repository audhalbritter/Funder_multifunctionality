...
- Average multifunctionality increased with the number of functional groups present (Figure 2). This effect is stronger for warmer sites when fewer functional groups are present and vice versa for colder sites when more functional groups are present (a bit unclear how this works...). -> Note that there was an effect of temperature before I added the phosphrous data. Now there is only an effect of functional group richness.
