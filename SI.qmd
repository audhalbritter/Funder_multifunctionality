...
```{r}
#| label: fig-root-data-plot
#| echo: false
#| warning: false
#| fig-cap: Different root data plotted in the same figure.

tar_read(root_data_plot)
...
```{r}
#| label: fig-decomposition-data-plot
#| echo: false
#| warning: false
#| fig-cap: Decomposition data for only graminoids, forbs and their average.

tar_read(decomposition_data_plot)
